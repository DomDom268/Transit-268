...
your_api_key = 'be1ff994c1aff728a77935c637723a55' #API key for authentication, generated when vehicle is added to database. Can be found in the vehicles table in the database
